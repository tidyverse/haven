...
Thanks for using haven! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/batpigandme/haven/issues/new).
...
requests](https://github.com/batpigandme/haven/issues) to make sure the
