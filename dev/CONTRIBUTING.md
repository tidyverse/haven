...
This outlines how to propose a change to haven. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/haven", fork = TRUE)`.
...
of Conduct](https://haven.tidyverse.org/dev/CODE_OF_CONDUCT.md). By
