...
haven 1.0.0 is a major release indicating the haven is now largely feature complete and has been tested on many real world datasets.
...
Whole bunch of other minor improvements and bug fixes: you can see the complete list in the [release notes](http://haven.tidyverse.org/news/index.html#haven-1.0.0).

## ReadStat

Haven build on top of the [ReadStat](http://github.com/WizardMac/ReadStat/issues) C library by [Evan Miller](http://www.evanmiller.org). This version of haven includes many improvements thanks to Evan's hard work on ReadStat:

* Cana read binary/Ross compressed SAS files.
...
* Many many many other bug fixes and minor improvements.
