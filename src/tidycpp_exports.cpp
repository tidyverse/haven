...
extern "C" SEXP _tidycpp_write_sav_(SEXP data, SEXP path, SEXP compress) {
  BEGIN_TIDYCPP
    write_sav_(tidycpp::as_cpp<tidycpp::list>(data), tidycpp::as_cpp<tidycpp::character_vector>(path), tidycpp::as_cpp<bool>(compress));
  return R_NilValue;
  END_TIDYCPP
}
// DfWriter.cpp
...
extern "C" SEXP _tidycpp_write_dta_(SEXP data, SEXP path, SEXP version, SEXP label) {
  BEGIN_TIDYCPP
    write_dta_(tidycpp::as_cpp<tidycpp::list>(data), tidycpp::as_cpp<tidycpp::character_vector>(path), tidycpp::as_cpp<int>(version), tidycpp::as_cpp<tidycpp::sexp>(label));
  return R_NilValue;
  END_TIDYCPP
}
// DfWriter.cpp
...
extern "C" SEXP _tidycpp_write_sas_(SEXP data, SEXP path) {
  BEGIN_TIDYCPP
    write_sas_(tidycpp::as_cpp<tidycpp::list>(data), tidycpp::as_cpp<tidycpp::character_vector>(path));
  return R_NilValue;
  END_TIDYCPP
}
// DfWriter.cpp
...
extern "C" SEXP _tidycpp_write_xpt_(SEXP data, SEXP path, SEXP version, SEXP name) {
  BEGIN_TIDYCPP
    write_xpt_(tidycpp::as_cpp<tidycpp::list>(data), tidycpp::as_cpp<tidycpp::character_vector>(path), tidycpp::as_cpp<int>(version), tidycpp::as_cpp<std::string>(name));
  return R_NilValue;
  END_TIDYCPP
}
