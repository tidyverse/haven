...
public:
  ...
  void skipCols(cpp11::integers cols) {
    std::set<int> cols_set(cols.begin(), cols.end());
    colsSkip_ = cols_set;
  }
  ...
  cpp11::list output() {
    ...
    return SEXP(as_tibble(output_, ".rows"_nm = nrows_, ".name_repair"_nm = cpp11::r_string("none")));
  }
};
