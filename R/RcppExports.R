...
df_parse_sas_file <- function(spec_b7dat, spec_b7cat, encoding, catalog_encoding, cols_only, n_max) {
    .Call(`_haven_df_parse_sas_file`, spec_b7dat, spec_b7cat, encoding, catalog_encoding, cols_only, n_max)
}

df_parse_sas_raw <- function(spec_b7dat, spec_b7cat, encoding, catalog_encoding, cols_only, n_max) {
    .Call(`_haven_df_parse_sas_raw`, spec_b7dat, spec_b7cat, encoding, catalog_encoding, cols_only, n_max)
}
