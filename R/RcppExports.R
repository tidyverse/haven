...
df_parse_sas_file <- function(spec_b7dat, spec_b7cat, encoding, catalog_encoding, cols_only) {
    .Call(`_haven_df_parse_sas_file`, spec_b7dat, spec_b7cat, encoding, catalog_encoding, cols_only)
}
