...
df_parse_sas_file <- function(spec_b7dat, spec_b7cat) {
    .Call('haven_df_parse_sas_file', PACKAGE = 'haven', spec_b7dat, spec_b7cat)
}

df_parse_sas_raw <- function(spec_b7dat, spec_b7cat) {
    .Call('haven_df_parse_sas_raw', PACKAGE = 'haven', spec_b7dat, spec_b7cat)
}
